...
export type StorageHash =
  StorageHashBase<'264a74de38e19630c81d4b0c903438e18fa6328a6918f96b22de574b0e8a0fd6'>;
...
export namespace Models {
  export type public_User = {
    ...
    employers: public_Employer[];
    tasks: public_Task[];
    readonly [RelationKeys]?: 'applications' | 'contacts' | 'employers' | 'tasks';
  };
  export type public_Employer = {
    ...
    contacts: public_Contact[];
    user: public_User;
    readonly [RelationKeys]?: 'applications' | 'contacts' | 'user';
  };
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly employer: {
              ...
              indexes: readonly [
                {
                  readonly name: 'employer_userId_idx_a489d58a';
                  readonly prefix: 'employer_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
